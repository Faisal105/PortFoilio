    ...
    protected function _register_controls() {
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors'  => [
                    '{{WRAPPER}} .eae-search-icon i' => 'font-size: {{SIZE}}{{UNIT}}',
                ],
                'condition'   => [
                    'eae_table_search' => 'yes', 
                ],
        ...
        $this->add_control(
			...
			[
                ...
                'default' => '#7A7A7A73',
				'selectors' => [
                    '{{WRAPPER}} .eae-search-icon i' => 'color: {{VALUE}}',
                ],
                'condition' => [
					'eae_table_search' => 'yes',
                ],
        ...
        $this->add_control(
			...
			[
                ...
                'default' => '#eceeef',
				'selectors' => [
                    '{{WRAPPER}} .eae-search-icon' => 'background-color: {{VALUE}}',
                ],
                'condition' => [
					'eae_table_search' => 'yes',
                ],
        ...
        $this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} .eae-search-icon' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
