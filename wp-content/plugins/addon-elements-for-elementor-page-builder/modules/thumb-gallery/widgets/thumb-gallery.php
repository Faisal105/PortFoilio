    ...
    protected function _register_controls()
	{
        ...
        $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
                    '{{WRAPPER}} .eae-swiper-pagination .swiper-pagination-bullet' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .eae-swiper-pagination.swiper-pagination-fraction' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .eae-swiper-pagination.swiper-pagination-progressbar' => 'background-color: {{VALUE}};',
                ],
                'condition' => [
					'slider_pagination!' => '',
                ],
        ...
        $this->add_control(
			...
			[
				...
				'type' => Controls_Manager::COLOR,
				'selectors' => [
                    '{{WRAPPER}} .eae-swiper-pagination .swiper-pagination-bullet-active' => 'background-color: {{VALUE}};',
                    '{{WRAPPER}} .eae-swiper-pagination .swiper-pagination-current' => 'color: {{VALUE}};',
                    '{{WRAPPER}} .eae-swiper-pagination .swiper-pagination-progressbar-fill' => 'background-color: {{VALUE}};',
                ],
                'condition' => [
					'slider_pagination!' => '',
                ],
        ...
        $this->add_control(
			...
			[
				...
				'selectors' => [
                    '{{WRAPPER}} .eae-swiper-pagination .swiper-pagination-bullet' => 'height: {{SIZE}}{{UNIT}}; width: {{SIZE}}{{UNIT}}',
                    '{{WRAPPER}} .eae-swiper-pagination.swiper-pagination-fraction' => 'font-size: {{SIZE}}{{UNIT}}',
					'{{WRAPPER}} .eae-swiper-pagination.swiper-pagination-progressbar' => 'height: {{SIZE}}{{UNIT}}', //.swiper-container-horizontal 		
				],
				'condition' => [
					'slider_pagination!' => '',
                ],
